...
def definition_as_type_application_term(el: hydra.core.Binding) -> Either[hydra.errors.Error, hydra.core.TypeApplicationTerm]:
    ...
    return hydra.lib.maybes.maybe((lambda : Left(cast(hydra.errors.Error, hydra.errors.ErrorExtraction(cast(hydra.errors.ExtractionError, hydra.errors.ExtractionErrorUnexpectedShape(hydra.errors.UnexpectedShapeError("typed binding", "untyped binding"))))))), (lambda ts: Right(hydra.core.TypeApplicationTerm(el.term, ts.body))), el.type_scheme)
