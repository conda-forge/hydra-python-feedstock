...
def eta_expand_term(tx0: hydra.graph.Graph, term0: hydra.core.Term) -> hydra.core.Term:
    ...
    def prim_types() -> FrozenDict[hydra.core.Name, hydra.core.TypeScheme]:
        return hydra.lib.maps.from_list(hydra.lib.lists.map((lambda _gpt_p: (_gpt_p.name, _gpt_p.type_scheme)), hydra.lib.maps.elems(tx0.primitives)))
        ...
        match term:
            ...
            case hydra.core.TermLet(value=lt):
                ...
                def map_binding(b: hydra.core.Binding) -> hydra.core.Binding:
                    return hydra.core.Binding(b.name, rewrite_with_args((), tx1(), b.term), b.type_scheme)
                @lru_cache(1)
                def result() -> hydra.core.Term:
...
def eta_expansion_arity(graph: hydra.graph.Graph, term: hydra.core.Term) -> int:
    ...
    match term:
        ...
        case hydra.core.TermVariable(value=name):
            return hydra.lib.maybes.maybe((lambda : 0), (lambda ts: hydra.arity.type_arity(ts.body)), hydra.lib.maybes.bind(hydra.lexical.lookup_binding(graph, name), (lambda b: b.type_scheme)))
        case _:
            return 0
        ...
        match stripped():
            ...
            case hydra.core.TermLet(value=lt):
                ...
                def expand_binding(b: hydra.core.Binding) -> hydra.core.Binding:
                    return hydra.core.Binding(b.name, hydra.variables.replace_free_term_variable(b.name, let_expr(b), b.term), b.type_scheme)
                @lru_cache(1)
