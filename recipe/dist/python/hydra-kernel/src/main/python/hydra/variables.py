        ...
        match term:
            ...
            case hydra.core.TermLet(value=l2):
                def for_binding(b: hydra.core.Binding) -> frozenset[hydra.core.Name]:
                    ...
                    return hydra.lib.sets.union(get_all(new_vars(), b.term), hydra.lib.maybes.maybe((lambda : hydra.lib.sets.empty()), (lambda ts: try_type(new_vars(), ts.body)), b.type_scheme))
