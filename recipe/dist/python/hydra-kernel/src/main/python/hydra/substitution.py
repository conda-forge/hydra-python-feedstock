...
def subst_in_type_scheme(subst: hydra.typing.TypeSubst, ts: hydra.core.TypeScheme) -> hydra.core.TypeScheme:
    r"""Apply a type substitution to a type scheme. The scheme's quantifier variables shadow the substitution: any name in typeSchemeVariables is removed from subst before substituting into the body and constraints. Without this, a substitution like {t0 -> Foo} applied to `forall [t0]. t0 -> t0` would incorrectly replace the bound t0."""
    @lru_cache(1)
    def scoped_subst() -> hydra.typing.TypeSubst:
        return hydra.typing.TypeSubst(hydra.lib.lists.foldl((lambda m, v: hydra.lib.maps.delete(v, m)), subst.value, ts.variables))
    return hydra.core.TypeScheme(ts.variables, subst_in_type(scoped_subst(), ts.body), hydra.lib.maybes.map((lambda v1: subst_in_class_constraints(scoped_subst(), v1)), ts.constraints))
    ...
    def rewrite(recurse: Callable[[hydra.core.Term], hydra.core.Term], term: hydra.core.Term) -> hydra.core.Term:
        ...
        def for_let(l: hydra.core.Let) -> hydra.core.Term:
            def rewrite_binding(b: hydra.core.Binding) -> hydra.core.Binding:
                return hydra.core.Binding(b.name, subst_types_in_term(subst, b.term), hydra.lib.maybes.map((lambda v1: subst_in_type_scheme(subst, v1)), b.type_scheme))
...
def substitute_in_term(subst: hydra.typing.TermSubst, term0: hydra.core.Term) -> hydra.core.Term:
    ...
    def rewrite(recurse: Callable[[hydra.core.Term], hydra.core.Term], term: hydra.core.Term) -> hydra.core.Term:
        ...
        def with_let(lt: hydra.core.Let) -> hydra.core.Term:
            ...
            def rewrite_binding(b: hydra.core.Binding) -> hydra.core.Binding:
                return hydra.core.Binding(b.name, substitute_in_term(subst2(), b.term), b.type_scheme)
...
def substitute_in_binding(subst: hydra.typing.TermSubst, b: hydra.core.Binding) -> hydra.core.Binding:
    ...
    return hydra.core.Binding(b.name, substitute_in_term(subst, b.term), b.type_scheme)
