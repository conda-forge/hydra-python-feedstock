    ...
    def _hoist_hydra_decode_packaging_term_definition_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                return hydra.lib.eithers.bind(hydra.extract.core.require_field("name", (lambda x1, x2: hydra.decode.core.name(x1, x2)), field_map(), cx), (lambda field_name: hydra.lib.eithers.bind(hydra.extract.core.require_field("term", (lambda x1, x2: hydra.decode.core.term(x1, x2)), field_map(), cx), (lambda field_term: hydra.lib.eithers.bind(hydra.extract.core.require_field("typeScheme", (lambda v12, v2: hydra.extract.core.decode_maybe((lambda x1, x2: hydra.decode.core.type_scheme(x1, x2)), v12, v2)), field_map(), cx), (lambda field_type_scheme: Right(hydra.packaging.TermDefinition(field_name, field_term, field_type_scheme))))))))
            case _:
    ...
    def _hoist_hydra_decode_packaging_type_definition_1(cx, v1):
        match v1:
            case hydra.core.TermRecord(value=record):
                ...
                def field_map() -> FrozenDict[hydra.core.Name, hydra.core.Term]:
                    return hydra.extract.core.to_field_map(record)
                return hydra.lib.eithers.bind(hydra.extract.core.require_field("name", (lambda x1, x2: hydra.decode.core.name(x1, x2)), field_map(), cx), (lambda field_name: hydra.lib.eithers.bind(hydra.extract.core.require_field("typeScheme", (lambda x1, x2: hydra.decode.core.type_scheme(x1, x2)), field_map(), cx), (lambda field_type_scheme: Right(hydra.packaging.TypeDefinition(field_name, field_type_scheme))))))
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
            ...
            case hydra.core.TermRecord(value=record):
                ...
                def _hoist_field_map_body_2(v12):
                    match v12:
                        ...
                        case _:
                            return Left(hydra.errors.DecodingError("expected literal"))
                return hydra.lib.eithers.bind(hydra.extract.core.require_field("description", (lambda v12, v2: hydra.extract.core.decode_maybe((lambda cx2, raw2: hydra.lib.eithers.either((lambda err: Left(err)), (lambda stripped2: _hoist_field_map_body_2(stripped2)), hydra.extract.core.strip_with_decoding_error(cx2, raw2))), v12, v2)), field_map(), cx), (lambda field_description: hydra.lib.eithers.bind(hydra.extract.core.require_field("namespace", (lambda x1, x2: namespace(x1, x2)), field_map(), cx), (lambda field_namespace: hydra.lib.eithers.bind(hydra.extract.core.require_field("termDependencies", (lambda v12, v2: hydra.extract.core.decode_list((lambda x1, x2: namespace(x1, x2)), v12, v2)), field_map(), cx), (lambda field_term_dependencies: hydra.lib.eithers.bind(hydra.extract.core.require_field("typeDependencies", (lambda v12, v2: hydra.extract.core.decode_list((lambda x1, x2: namespace(x1, x2)), v12, v2)), field_map(), cx), (lambda field_type_dependencies: hydra.lib.eithers.bind(hydra.extract.core.require_field("definitions", (lambda v12, v2: hydra.extract.core.decode_list((lambda x1, x2: definition(x1, x2)), v12, v2)), field_map(), cx), (lambda field_definitions: Right(hydra.packaging.Module(field_description, field_namespace, field_term_dependencies, field_type_dependencies, field_definitions))))))))))))
            case _:
                return Left(hydra.errors.DecodingError("expected record"))
