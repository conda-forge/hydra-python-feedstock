...
def is_native_type(el: hydra.core.Binding) -> bool:
    ...
    return hydra.lib.maybes.maybe((lambda : False), (lambda ts: hydra.lib.logic.and_(hydra.lib.equality.equal(ts, hydra.core.TypeScheme((), cast(hydra.core.Type, hydra.core.TypeVariable(hydra.core.Name("hydra.core.Type"))), Nothing())), hydra.lib.logic.not_(is_flagged_as_first_class_type()))), el.type_scheme)
