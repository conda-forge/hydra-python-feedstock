...
def field_types(cx: T0, graph: hydra.graph.Graph, t: hydra.core.Type) -> Either[hydra.errors.Error, FrozenDict[hydra.core.Name, hydra.core.Type]]:
    ...
    match hydra.strip.deannotate_type(t):
        ...
        case hydra.core.TypeVariable(value=name):
            return hydra.lib.maybes.maybe((lambda : hydra.lib.eithers.bind(hydra.lexical.require_binding(graph, name), (lambda el: hydra.lib.eithers.bind(hydra.lib.eithers.bimap((lambda _e: cast(hydra.errors.Error, hydra.errors.ErrorResolution(cast(hydra.errors.ResolutionError, hydra.errors.ResolutionErrorUnexpectedShape(hydra.errors.UnexpectedShapeError("type", _e.value)))))), (lambda _a: _a), hydra.decode.core.type(graph, el.term)), (lambda decoded_type: field_types(cx, graph, decoded_type)))))), (lambda ts: field_types(cx, graph, ts.body)), hydra.lib.maps.lookup(name, graph.schema_types))
        case _:
...
def instantiate_type_scheme(cx: hydra.context.Context, scheme: hydra.core.TypeScheme) -> tuple[hydra.core.TypeScheme, hydra.context.Context]:
    ...
    return (hydra.core.TypeScheme(new_vars(), hydra.substitution.subst_in_type(subst(), scheme.body), renamed_constraints()), cx2())
