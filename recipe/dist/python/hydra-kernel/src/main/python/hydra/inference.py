...
def infer_type_of_projection(fcx: hydra.context.Context, cx: hydra.graph.Graph, proj: hydra.core.Projection) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    ...
    fname = proj.field
    return hydra.lib.eithers.bind(hydra.resolution.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.body, hydra.lib.eithers.bind(hydra.extract.core.record_type(tname, stype), (lambda sfields: hydra.lib.eithers.bind(hydra.resolution.find_field_type(fcx2, fname, sfields), (lambda ftyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermProject(hydra.core.Projection(tname, fname)))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.resolution.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), ftyp))), hydra.substitution.id_type_subst())))))))[4]))
...
def infer_type_of_unwrap(fcx: hydra.context.Context, cx: hydra.graph.Graph, tname: hydra.core.Name) -> Either[hydra.errors.Error, hydra.typing.InferenceResult]:
    ...
    return hydra.lib.eithers.bind(hydra.resolution.require_schema_type(fcx, cx.schema_types, tname), (lambda st_rp: (schema_type := hydra.lib.pairs.first(st_rp), fcx2 := hydra.lib.pairs.second(st_rp), svars := schema_type.variables, stype := schema_type.body, hydra.lib.eithers.bind(hydra.extract.core.wrapped_type(tname, stype), (lambda wtyp: Right(yield_(fcx2, build_type_application_term(svars, cast(hydra.core.Term, hydra.core.TermUnwrap(tname))), cast(hydra.core.Type, hydra.core.TypeFunction(hydra.core.FunctionType(hydra.resolution.nominal_application(tname, hydra.lib.lists.map((lambda x: cast(hydra.core.Type, hydra.core.TypeVariable(x))), svars)), wtyp))), hydra.substitution.id_type_subst())))))[4]))
