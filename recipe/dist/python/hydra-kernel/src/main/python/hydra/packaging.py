...
class TermDefinition:
    ...
    type_scheme: Annotated[Maybe[hydra.core.TypeScheme], "The type scheme of the term, including any class constraints"]
    TYPE_ = hydra.core.Name("hydra.packaging.TermDefinition")
    NAME = hydra.core.Name("name")
    TERM = hydra.core.Name("term")
    TYPE_SCHEME = hydra.core.Name("typeScheme")
@dataclass(frozen=True)
class TypeDefinition:
    r"""A type-level definition, including a name and the type scheme."""
    name: Annotated[hydra.core.Name, "The name of the type"]
    type_scheme: Annotated[hydra.core.TypeScheme, "The type scheme being defined"]
